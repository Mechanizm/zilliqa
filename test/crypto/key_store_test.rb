...
class KeyStoreTest < Minitest::Test
  def test_encrypt_private_key
    ...
    json = key_store.encrypt_private_key(private_key, "xiaohuo", Zilliqa::Crypto::KeyStore::T_PBKDF2);
    ret = key_store.decrypt_private_key(json, "xiaohuo");
    assert_equal private_key, ret

    json = key_store.encrypt_private_key(private_key, "xiaohuo", Zilliqa::Crypto::KeyStore::T_SCRYPT);
    ret = key_store.decrypt_private_key(json, "xiaohuo");
    assert_equal private_key, ret
  end
