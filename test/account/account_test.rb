...
class AccountTest < Minitest::Test
  ...
  def test_from_file
    ...
    account = Zilliqa::Account::Account.from_file(json, "xiaohuo")
  ...
  def test_to_file
    ...
    json = account.to_file('xiaohuo', Zilliqa::Crypto::KeyStore::T_PBKDF2)

    account_restore = Zilliqa::Account::Account.from_file(json, "xiaohuo")
